...
void main() { 
	...
	redCurveValue = texture2D(sTexture2, vec2(tColor.r, 1.0)).r;
	greenCurveValue = texture2D(sTexture2, vec2(tColor.g, 1.0)).r;
	blueCurveValue = texture2D(sTexture2, vec2(tColor.b, 1.0)).r;
