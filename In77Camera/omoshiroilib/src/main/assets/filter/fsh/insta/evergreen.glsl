...
{ 
    ...
    redCurveValue = texture2D(sTexture2, vec2(tColor.r, 0.0)).b;
	greenCurveValue = texture2D(sTexture2, vec2(tColor.g, 0.0)).b;
	blueCurveValue = texture2D(sTexture2, vec2(tColor.b, 0.0)).b;
	redCurveValue = texture2D(sTexture2, vec2(redCurveValue, 0.0)).r;
	blueCurveValue = texture2D(sTexture2, vec2(blueCurveValue, 0.0)).g;
