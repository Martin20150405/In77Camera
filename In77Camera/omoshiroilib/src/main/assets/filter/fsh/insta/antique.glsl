...
void main()
{
	...
	redCurveValue = texture2D(sTexture2, vec2(redCurveValue, 0.0)).a;
	greenCurveValue = texture2D(sTexture2, vec2(greenCurveValue, 0.0)).a;
	blueCurveValue = texture2D(sTexture2, vec2(blueCurveValue, 0.0)).a;
