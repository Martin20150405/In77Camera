...
void main() { 
	...
	blurColor = gaussianBlur(sTexture);
	...
	lowp float greenCurveValue = texture2D(sTexture2, vec2(textureColor.g, 0.0)).r;
    lowp float blueCurveValue = texture2D(sTexture2, vec2(textureColor.b, 0.0)).r;
