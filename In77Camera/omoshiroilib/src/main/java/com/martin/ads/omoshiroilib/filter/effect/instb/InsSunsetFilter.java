...
public class InsSunsetFilter extends MultipleTextureFilter {
    ...
    public void init() {
        ...
        externalBitmapTextures[1].load(context, "filter/textures/inst/rise_mask1.jpg");
        externalBitmapTextures[2].load(context, "filter/textures/inst/rise_mask2.jpg");
    }
    ...
    private int prepareRawTexture1(){
        ...
        return TextureUtils.getTextureFromByteArray(arrayOfByte,256,2);
    }
}
